            ...
            try
            {
                using (StreamReader sr = new StreamReader(openFileDialog1.FileName))
                {
                    while (ide)
                    {
                        ...
                        int TimID =0,starost=0, Broj_Utakmica, Broj_Utakmica_Starter=0, Broj_Minuta, Pogodjeni_Sve, Pokusani_Sve, ThreeMade, ThreeAtt, TwoMade, TwoAtt, FreeMade,FreeAtt,ORB,DRB,TRB,AST,STL,BLK,TO,FLS,PTS,igracID=0;
                        string ime="",prezime="";
                        if (prvi_unos)
                        {
                            linija = sr.ReadLine();
                            ime = linija.Split(' ')[0];
                            prezime = linija.Split(' ')[1];
                            prvi_unos = false;
                        }
                        try
                        {
                            ...
                            DAL.DAL.IgracDAO cd1 = new DAL.DAL.IgracDAO();
                            Igrac i = cd1.getByTwoExamples(ime, prezime);
                            igracID = i.Daj_Igrac_ID;
                        ...
                        if (!checkBox1.Checked)
                        {
                            SezonskiPodaci f = new SezonskiPodaci(godina_sezone,starost, TimID, Pozicija, Broj_Utakmica, Broj_Utakmica_Starter, Broj_Minuta, Pokusani_Sve, Pogodjeni_Sve, ThreeAtt, ThreeMade, TwoAtt, TwoMade, FreeAtt, FreeMade, ORB, DRB, AST, BLK, STL, TO, FLS, PTS, igracID);
                        ...
                        {
                            SezonskiPodaci f = new SezonskiPodaci("2013-14",0, 35, "N/A", Broj_Utakmica, Broj_Utakmica, Broj_Minuta, Pokusani_Sve, Pogodjeni_Sve, ThreeAtt, ThreeMade, TwoAtt, TwoMade, FreeAtt, FreeMade, ORB, DRB, AST, BLK, STL, TO, FLS, PTS,444);
                            f.DajProcenat_Sut_Sve = PCT_Sve;
                            f.DajProcenat_Sut_3 = ThreePCT;
                            f.DajProcenat_Sut_2 = TwoPCT;
                            f.DajProcenat_Sut_1 = FreePCT;
